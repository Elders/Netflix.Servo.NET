...
namespace Elders.Servo.NET
{
  ...
  * {@link com.Elders.Servo.NET.annotations.Monitor} annotations.
  */
 ...
 * {@code com.Elders.Servo.NET.DefaultMonitorRegistry.registryClass} property. The
 ...
 * {@link com.Elders.Servo.NET.jmx.JmxMonitorRegistry} will be used.
 * <p/>
 * If the default {@link com.Elders.Servo.NET.jmx.JmxMonitorRegistry} is used, the property
 * {@code com.Elders.Servo.NET.DefaultMonitorRegistry.jmxMapperClass} can optionally be
 * specified to control how monitors are mapped to JMX {@link javax.management.ObjectName}.
 * This property specifies the {@link com.Elders.Servo.NET.jmx.ObjectNameMapper}
 ...
 */
    public class DefaultMonitorRegistry : IMonitorRegistry
    {
        ...
        //private static String DEFAULT_REGISTRY_NAME = "com.Elders.Servo.NET";
